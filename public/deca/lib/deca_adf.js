...
var wasmBinaryFile = "deca_adf.wasm";
...
function _bool_push(value) {
  Module.adf_stack.push(value);
}
function _db_error(offset, sz) {
...
function _db_print(offset, sz) {
  const str_raw = new Uint8Array(Module.HEAPU8.buffer, offset, sz);
  const str = new TextDecoder("utf-8").decode(str_raw);
  console.log("db_print:", str);
}
function _db_warn(offset, sz) {
  const str_raw = new Uint8Array(Module.HEAPU8.buffer, offset, sz);
  const str = new TextDecoder("utf-8").decode(str_raw);
  console.warn("db_warn:", str);
}
function _dict_field_set() {
...
function _enum_push(value, offset, sz) {
  const str_raw = new Uint8Array(Module.HEAPU8.buffer, offset, sz);
  const str = new TextDecoder("utf-8").decode(str_raw);
...
function _f32_push(value) {
  Module.adf_stack.push(value);
}
function _f32s_push(offset, cnt) {
  Module.adf_stack.push(new Float32Array(Module.HEAPU8.buffer, offset, cnt));
}
function _f64_push(value) {
  Module.adf_stack.push(value);
}
function _f64s_push(offset, cnt) {
  Module.adf_stack.push(new Float64Array(Module.HEAPU8.buffer, offset, cnt));
}
function _hash32_push(value) {
  Module.adf_stack.push(value);
}
function _hash48_push(value) {
  Module.adf_stack.push(value);
}
function _hash64_push(value) {
  Module.adf_stack.push(value);
}
...
function _u16_push(value) {
  Module.adf_stack.push(value);
}
function _u16s_push(offset, cnt) {
  Module.adf_stack.push(new Uint16Array(Module.HEAPU8.buffer, offset, cnt));
}
function _u32_push(value) {
  Module.adf_stack.push(value);
}
function _u32s_push(offset, cnt) {
  Module.adf_stack.push(new Uint32Array(Module.HEAPU8.buffer, offset, cnt));
}
function _u64_push(value) {
  Module.adf_stack.push(value);
}
function _u64s_push(offset, cnt) {
  Module.adf_stack.push(new BigUint64Array(Module.HEAPU8.buffer, offset, cnt));
}
function _u8_push(value) {
  Module.adf_stack.push(value);
}
function _u8s_push(offset, cnt) {
...
var _alloc_bin = (Module["_alloc_bin"] = function () {
  return (_alloc_bin = Module["_alloc_bin"] = Module["asm"]["S"]).apply(
    null,
    arguments
  );
});
var _process_adf = (Module["_process_adf"] = function () {
  return (_process_adf = Module["_process_adf"] = Module["asm"]["T"]).apply(
    null,
    arguments
  );
});
...
var dynCall_vi = (Module["dynCall_vi"] = function () {
  return (dynCall_vi = Module["dynCall_vi"] = Module["asm"]["X"]).apply(
    null,
    arguments
  );
});
var dynCall_v = (Module["dynCall_v"] = function () {
  return (dynCall_v = Module["dynCall_v"] = Module["asm"]["Y"]).apply(
    null,
    arguments
  );
});
